...
CREATE  TABLE MESSAGES (
  ...
  CONSTRAINT CONNECTION_MESSAGE_CONSTRAINT FOREIGN KEY (CONNECTION_NAME) REFERENCES CONNECTIONS(CONNECTION_NAME) ON DELETE NO ACTION ON UPDATE NO ACTION
)ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE CONFIGURATION_PROPERTIES (
     ...
     DESCRIPTION VARCHAR(1024),
     PRIMARY KEY (MESSAGE_NAME,PROP_KEY),
     CONSTRAINT CONFIGURATION_MESSAGE_CONSTRAINT FOREIGN KEY (MESSAGE_NAME) REFERENCES MESSAGES(MESSAGE_NAME) ON DELETE NO ACTION ON UPDATE NO ACTION
)ENGINE=INNODB DEFAULT CHARSET=UTF8;
...
CREATE TABLE CONNECTION_PROPERTIES (
     ...
     PROP_VALUE VARCHAR(1024),
     DESCRIPTION VARCHAR(1024),
     PRIMARY KEY (CONNECTION_NAME,PROP_KEY),
     CONSTRAINT CONNECTION_PROPERTIES_CONSTRAINT FOREIGN KEY (CONNECTION_NAME) REFERENCES CONNECTIONS(CONNECTION_NAME) ON DELETE NO ACTION ON UPDATE NO ACTION
)ENGINE=INNODB DEFAULT CHARSET=UTF8;