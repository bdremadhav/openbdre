      ...
      <h3><div class="number-circular">1</div>Output Table Details:</h3>
           <section >
           					<div >
           						...
           						<input id = "dbURL"  name = "common_dbURL" type = "text" class = "form-control" />
           						</div>
           						<div class="form-group">
           						<label for = "dbUser" ><spring:message code="dataimportwizard.page.db_user"/></label >
           						<input id = "dbUser"  name = "common_dbUser" type = "text" class = "form-control"  />
           						</div>
           						<div class="form-group">
           						<label for = "dbPassword" ><spring:message code="dataimportwizard.page.db_psswd"/></label >
           						<input id = "dbPassword" name = "common_dbPassword" type = "password" class = "form-control"  />
           						</div>
           						<div class="form-group">
           						<label for = "dbDriver" ><spring:message code="dataimportwizard.page.db_driver"/></label >
           						<input id = "dbDriver" name = "common_dbDriver" type = "text" class = "form-control" />
           						</div>
           						<div class="form-group">
           						<label for = "dbSchema" ><spring:message code="dataimportwizard.page.schema"/></label >
                                   <input id = "dbSchema"  name = "common_dbSchema" type = "text" class = "form-control" />
           						</div>
            ...
            <form class="form-horizontal" role="form" id="processFieldsForm3">
                <div id="InputDataDetails">
                    ...
                    <div id="InputDataDetails2">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="inputHDFSDir">Input HDFS Directory</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputHDFSDir"  >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="inputDataDelimiter">Delimiter</label>
                            <div class="col-sm-10">
